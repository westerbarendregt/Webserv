...
Request::Request()
	: m_method(-1), m_path(""), m_protocol(-1), m_content_length(0), m_headers(0), m_if_body(false), m_body(""), m_metadata_parsed(false), m_done(false), m_chunked(false), m_error(0), m_start(0)
{
	for (int i = 0; i < 18; ++i)
		m_headers.push_back("");
}
